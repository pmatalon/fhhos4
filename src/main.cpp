...
void print_usage() {
	...
	cout << "              aggregamg    - In-house implementation of AGMG, without the outer Krylov iteration" << endl;
	cout << "              fcgaggregamg - Flexible Conjugate Gradient FCG(1), preconditioned with '' (corresponds to an in-house implementation of AGMG" << endl;
	cout << "              hoaggregamg  - p-multigrid on top of aggregamg" << endl;
