...
public:
	Diffusion_DG(Mesh<Dim>* mesh, string rhsCode, DomFunction sourceFunction, DiffusionPartition<Dim>* diffusionPartition, string outputDirectory, FunctionalBasis<Dim>* basis, int penalizationCoefficient)
