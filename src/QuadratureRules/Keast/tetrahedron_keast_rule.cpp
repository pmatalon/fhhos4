...
namespace tetrahedron_keast_rule {
...
//
{
  ...
  jlo = tetrahedron_keast_rule::i4_min ( ilo, ihi );
  jhi = tetrahedron_keast_rule::i4_max ( ilo, ihi );
  ...
  {
    value = jlo + tetrahedron_keast_rule::i4_modp ( ival - jlo, wide );
  }
...
//
    else if ( suborder[s] == 4 )
    {
      for ( k = 0; k < 4; k++ )
      {
        xyz[0+o*3] = suborder_xyzz [tetrahedron_keast_rule::i4_wrap(k,  0,3) + s*4 ];
        xyz[1+o*3] = suborder_xyzz [tetrahedron_keast_rule::i4_wrap(k+1,0,3) + s*4 ];
        xyz[2+o*3] = suborder_xyzz [tetrahedron_keast_rule::i4_wrap(k+2,0,3) + s*4 ];
        w[o] = suborder_w[s];
        o = o + 1;
      }
    }
...
//
    else if ( suborder[s] == 12 )
    {
      ...
      for ( k = 0; k < 3; k++ )
      {
        xyz[0+o*3] = suborder_xyzz [tetrahedron_keast_rule::i4_wrap(k+1,1,3) + s*4 ];
        xyz[1+o*3] = suborder_xyzz [tetrahedron_keast_rule::i4_wrap(k+2,1,3) + s*4 ];
        xyz[2+o*3] = suborder_xyzz [tetrahedron_keast_rule::i4_wrap(k+3,1,3) + s*4 ];
        w[o] = suborder_w[s];
        o = o + 1;
      }
      for ( k = 0; k < 3; k++ )
      {
        xyz[0+o*3] = suborder_xyzz [tetrahedron_keast_rule::i4_wrap(k+1,1,3) + s*4 ];
        xyz[1+o*3] = suborder_xyzz [tetrahedron_keast_rule::i4_wrap(k+3,1,3) + s*4 ];
        xyz[2+o*3] = suborder_xyzz [tetrahedron_keast_rule::i4_wrap(k+2,1,3) + s*4 ];
        w[o] = suborder_w[s];
        o = o + 1;
      }
    }
...
//
{
  ...
  volume = fabs (tetrahedron_keast_rule::r8mat_det_4d ( a ) ) / 6.0;
